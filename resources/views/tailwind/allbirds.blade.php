...
<title>Allbirds Code w/Tailwind CSS</title>
...
<body class="bg-gray-600">
    <div class="mx-auto bg-white" style="width: 480px">

        <div class="px-4 py-1 bg-green-700 text-white">
        ...
        <main>
            <div class="flex items-center justify-between px-6 pt-4 pb-3">
                <div>
                    <div class="text-xs font-medium text-gray-900 space-x-1">
                        <a href="#" class="underline">Home</a>
                        <span>/</span>
                    </div>
                    <div class="text-lg font-bold text-gray-900">Women's Shoes</div>
                </div>
                <div>
            ...
            {{-- body --}}
            <div class="py-8">
                <div class="flex space-x-4 bg-green-800 bg-opacity-20 px-8 py-3">
                    <div>
                        <svg class="-ml-2 h-14 w-14" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                        <div class="flex space-x-2">
                            <div class="text-sm font-semibold text-gray-900">Pay It To The Planet</div>
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>
                        <p class="mt-1 text-sm font-light text-gray-900 text-opacity-90">Every Black Friday purchase supports Fridays For Future</p>
                    </div>
                </div>
            </div>
