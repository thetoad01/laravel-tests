...
@section('title', 'Allbirds Clone Using Tailwind CSS')
...
@section('content')
<div class="bg-white">
    <div class="px-4 py-3 bg-gray-500 text-white">
        <p class="text-xs font-semibold text-center">
            Gift with confidence. Returns are extended till January 15th.
        </p>
    </div>

    <header class="z-10 sticky top-0 px-4 py-4 flex items-center justify-between bg-white shadow-lg">
        <div>
    ...
    <main>
        <div class="flex items-center justify-between px-6 pt-4 pb-3 md:px-12">
            <div>
                <div class="text-xs font-semibold text-gray-900 space-x-1">
                    <a href="#" class="underline">Home</a>
                    <span>/</span>
                </div>
                <div class="text-lg font-bold text-gray-900 md:text-xl">Women's Shoes</div>
            </div>
            <div>
                <button class="block w-6 h-6">
                    <svg class="transform rotate-90" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {{-- Category List --}}
        <div class="bg-gray-100 py-2 overflow-x-auto scrollbar-hidden">
            <div class="px-6 text-sm inline-flex space-x-4">
                <a href="#" class="text-gray-700 whitespace-nowrap">Woman's Running Shoes</a>
                <a href="#" class="text-gray-700 whitespace-nowrap">Everyday Sneakers</a>
                <a href="#" class="text-gray-700 whitespace-nowrap">Slip-Ons</a>
                <a href="#" class="text-gray-700 whitespace-nowrap">High Tops</a>
                <a href="#" class="text-gray-700 whitespace-nowrap">Boat Shoes</a>
                <a href="#" class="text-gray-700 whitespace-nowrap">Flats</a>
                <a href="#" class="text-gray-700 whitespace-nowrap">Weather Repellent Shoes</a>
            </div>
        </div>
        {{-- items --}}
        <div class="py-6 px-8 md:px-12">
            <div>
                <h2 class="text-lg font-semibold md:text-xl">Woman's Wool Runner Mizzles</h2>
                <p class="text-sm text-gray-800">Our weather-ready sneaker made with merino wool and Puddle Guard&#x2122;.</p>
            </div>

            <div class="md:grid md:grid-cols-2 md:gap-6 mt-4">
                <div class="shadow-xl lg:shadow-none">
                    <div class="shadow-lg">
                        <a href="#">
                            <div>
                                <img class="w-full" src="https://cdn.allbirds.com/image/fetch/q_auto,f_auto/w_530,f_auto,q_auto,b_rgb:f5f5f5/https://cdn.allbirds.com/image/upload/f_auto,q_auto/v1/production/colorway/en-US/images/6zdZ6PC1jhCrgl1lilg7N8/1" alt="">
                            </div>
                            <div class="px-4 pt-1">
                                <h3 class="text-sm font-semibold">Woman's Wool Runner Mizzles</h3>
                                <p class="mt-1 text-sm text-gray-800">Natural Gray (Cream Sole)</p>
                            </div>
                        </a>
    
                        <div class="px-4 pb-4 mt-1">
                            <p class="text-sm text-gray-800">$115</p>
    
                            <div class="mt-4 flex items-center space-x-4 md:space-x-2">
                                <button class="w-6 h-6 flex flex-col rounded-full border border-gray-300 overflow-hidden ring-2 focus:ring-2 ring-offset-1
                                    focus:ring-offset-1 ring-gray-300 focus:ring-gray-800 focus:outline-none transition 
                                    md:rounded-none md:h-8 md:w-8 md:border-0 md:ring-1 md:ring-gray-400">
                                    <span class="sr-only">Natural Gray (Cream Sole)</span>

                                    <span class="h-full w-full flex flex-col transform -rotate-45 md:hidden">
                                        <span class="w-6 h-3" style="background-color: #434343"></span>
                                        <span class="w-6 h-3" style="background-color: #908f8e"></span>
                                    </span>

                                    <span class="hidden md:h-full md:w-full md:flex">
                                        <img src="https://cdn.allbirds.com/image/fetch/q_auto,f_auto,w_60/https://cdn.allbirds.com/image/upload/f_auto,q_auto/v1/production/colorway/en-US/images/6zdZ6PC1jhCrgl1lilg7N8/1" alt="">
                                    </span>
                                </button>
    
                                <button class="w-6 h-6 flex flex-col rounded-full border border-gray-300 overflow-hidden transform -rotate-45 focus:ring-2 focus:ring-offset-1 focus:ring-gray-800 focus:outline-none transition">
                                    <span class="sr-only">Savanna Night (Cream Sole)</span>
                                    <span class="w-6 h-3" style="background-color: #353946"></span>
                                    <span class="w-6 h-3" style="background-color: #e2e2da"></span>
                                </button>
    
                                <button class="w-6 h-6 flex flex-col rounded-full border border-gray-300 overflow-hidden transform -rotate-45 focus:ring-2 focus:ring-offset-1 focus:ring-gray-800 focus:outline-none transition">
                                    <span class="sr-only">Natural Black (Dark Grey Sole)</span>
                                    <span class="w-6 h-3" style="background-color: #4a4a49"></span>
                                    <span class="w-6 h-3" style="background-color: #757679"></span>
                                </button>
    
                                <button class="h-7 w-7 border rounded-full flex items-center justify-center hover:border-gray-500 
                                    focus:ring-2 focus:ring-offset-1 focus:ring-gray-800 focus:outline-none transition
                                    md:rounded-none md:h-8 md:w-8 md:border-0 md:ring-1 md:ring-gray-200">
                        ...
                        <div class="border-t">
                            <button class="px-4 py-2 w-full flex items-center justify-between text-sm">
                ...
                <div class="hidden md:block">
                    <div class="relative">
                        <img class="w-full" src="/images/tailwind/W_PCT_WRM.jpg" alt="preview image">
                        <div class="absolute inset-0">
                            <div class="absolute inset-0 top-1/2 bg-gradient-to-t from-gray-900 opacity-95"></div>
                            <div class="absolute inset-x-0 bottom-0">
                                <p class="px-6 pb-4 font-semibold text-medium text-white capitalize">Cozy sneaker, stormy weather</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="py-10 px-8">
            <div>
                <h2 class="text-lg font-semibold">Woman's Wool Runner Mizzles</h2>
                <p class="text-sm text-gray-800">Our weather-ready sneaker made with merino wool and Puddle Guard&#x2122;.</p>
            </div>
            <div class="mt-4 shadow-xl">
                <div class="shadow-lg">
                    <a href="#">
                        <div>
                            <img src="https://cdn.allbirds.com/image/fetch/q_auto,f_auto/w_530,f_auto,q_auto,b_rgb:f5f5f5/https://cdn.allbirds.com/image/upload/f_auto,q_auto/v1/production/colorway/en-US/images/6zdZ6PC1jhCrgl1lilg7N8/1" alt="">
                        </div>
                        <div class="px-4 pt-1">
                            <h3 class="text-sm font-semibold">Woman's Wool Runner Mizzles</h3>
                            <p class="mt-1 text-sm text-gray-800">Natural Gray (Cream Sole)</p>
                    ...
                    <div class="px-4 pb-4 mt-1">
                        ...
                        <div class="flex space-x-4 mt-4">
                            <button class="w-6 h-6 flex flex-col rounded-full border border-gray-300 overflow-hidden transform -rotate-45 ring-2 ring-offset-1 ring-gray-300">
                                <span class="sr-only">Natural Gray (Cream Sole)</span>
                                <span class="w-6 h-3" style="background-color: #434343"></span>
                                <span class="w-6 h-3" style="background-color: #908f8e"></span>
                            </button>

                            <button class="w-6 h-6 flex flex-col rounded-full border border-gray-300 overflow-hidden transform -rotate-45">
                                <span class="sr-only">Savanna Night (Cream Sole)</span>
                                <span class="w-6 h-3" style="background-color: #353946"></span>
                                <span class="w-6 h-3" style="background-color: #e2e2da"></span>
                            </button>
        ...
        <div class="px-6">
            <form action="#">
                ...
                <div class="mt-1.5 relative">
                    <input type="text" name="email" class="block w-full px-4 py-2 text-white bg-gray-600 border-2 border-transparent focus:border-white focus:outline-none transition">
                    <div class="absolute inset-0 border-b-2 border-white pointer-events-none" aria-hidden></div>
                </div>

                <div class="mt-6">
                    <button type="submit" class="block w-full px-4 py-3 rounded text-white bg-gray-600 font-bold text-sm
                        uppercase tracking-widest hover:bg-white hover:text-gray-900">
                        Sign up
                    </button>
                </div>
            </form>
